          ...
          <SectionCard title={t('product.form_section_info')}>
            ...
            <Stack direction="row" spacing={2} sx={{ mb: 3 }}>
              <FormControl size="medium" sx={{ ...inputSx, flex: 1 }}>
                <InputLabel htmlFor="input-harga-beli">{t('product.purchase_price')}</InputLabel>
                <OutlinedInput
                  id="input-harga-beli"
              ...
              <FormControl size="medium" sx={{ ...inputSx, flex: 1 }}>
                <InputLabel htmlFor="input-harga-jual">{t('product.col_price')}</InputLabel>
                <OutlinedInput
                  id="input-harga-jual"
